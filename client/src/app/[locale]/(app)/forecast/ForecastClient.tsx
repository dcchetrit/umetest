...
export default function ForecastClient({ locale }: ForecastClientProps) {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const [budgetSummary, fundingSourcesData, expensesData, eventsData] = await Promise.all([
      ...
      // Set allocationsData to empty array since getBudgetAllocations is not available
