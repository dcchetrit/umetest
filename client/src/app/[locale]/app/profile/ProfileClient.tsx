  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (formData.weddingDate) {
        updateData.weddingDate = Timestamp.fromDate(new Date(formData.weddingDate));
      }
      ...
      setProfileData(prev => ({
        ...
        email: formData.email.trim(),
        weddingDate: formData.weddingDate ? Timestamp.fromDate(new Date(formData.weddingDate)) : prev.weddingDate,
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center bg-gray-100/50 rounded-lg p-1">
                <Link href="/en/app/profile" className={`px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 ${
                  locale === 'en' 
                    ? 'bg-white shadow-sm text-gray-900 border border-gray-200' 
                    : 'text-gray-600 hover:text-gray-900 hover:bg-white/50'
                }`}>🇺🇸</Link>
                <Link href="/fr/app/profile" className={`px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 ${
                  locale === 'fr' 
                    ? 'bg-white shadow-sm text-gray-900 border border-gray-200' 
                    : 'text-gray-600 hover:text-gray-900 hover:bg-white/50'
                }`}>🇫🇷</Link>
                <Link href="/es/app/profile" className={`px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 ${
                  locale === 'es' 
                    ? 'bg-white shadow-sm text-gray-900 border border-gray-200' 
                    : 'text-gray-600 hover:text-gray-900 hover:bg-white/50'
                }`}>🇪🇸</Link>
